            ...
            <div class="auth-form">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="form-checkbox">
                        ...
                        >
                        <label for="terms">
                            J'accepte les <a href="#" class="text-airbnb-pink hover:underline">conditions d'utilisation</a> et la <a href="#" class="text-airbnb-pink hover:underline">politique de confidentialité</a>
                        </label>
                    </div>
                ...
                <div class="text-center mt-6 pt-6 border-t border-gray-100">
                    <a href="{{ url('/') }}" class="text-sm text-gray-600 hover:text-airbnb-pink transition-colors">
                        ← Retour à l'accueil
                    </a>
                </div>
            </div>
